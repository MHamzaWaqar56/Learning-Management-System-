...
function CreateQuizModal({ courseId, existingQuiz, onSuccess, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let result;
      if (existingQuiz) {
        result = await quizApi.updateQuiz(existingQuiz._id, quizData, token);
        toast.success("Quiz updated successfully!");
      } else {
        result = await quizApi.createQuiz(courseId, quizData, token);
      ...
      toast.error(error.response?.data?.message || 
        (existingQuiz ? "Failed to update quiz" : "Failed to create quiz"));
    } finally {
